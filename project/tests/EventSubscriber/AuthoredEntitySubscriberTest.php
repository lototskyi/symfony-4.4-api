...
class AuthoredEntitySubscriberTest extends TestCase
{
    ...
    {
        return [
            [BlogPost::class, true, Request::METHOD_POST],
            [BlogPost::class, false, Request::METHOD_GET],
            ['NonExisting', false, Request::METHOD_GET],
            [Comment::class, true, Request::METHOD_POST],
        ];
    }

    /**
     * @return \PHPUnit\Framework\MockObject\MockObject|(TokenStorageInterface&\PHPUnit\Framework\MockObject\MockObject)
     */
    ...
    /**
     * @return MockObject|(ViewEvent&MockObject)
     */
    ...
    /**
     * @return (BlogPost&MockObject)|MockObject
     */
